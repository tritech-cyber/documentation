...
/*! Mbox home version 1.0.0 */
if(typeof mboxCreate!=="function"){var mboxCopyright="Copyright 1996-2010. Adobe Systems Incorporated. All rights reserved";
...
mboxSignaler=function(c,e){this.J=e;
var d=e.getCookieNames("signal-");
for(var f=0;
f<d.length;
f++){var g=d[f];
var b=e.getCookie(g).split("&");
var a=c(b[0],b);
a.load();
e.deleteCookie(g)
}};
...
mboxList.prototype.get=function(c){var d=new mboxList();
for(var b=0;
b<this.F.length;
b++){var a=this.F[b];
if(a.getName()==c){d.add(a)
}}return d
};
...
mboxCreate=function(b){var a=mboxFactoryDefault.create(b,mboxShiftArray(arguments));
if(a){a.load()
}return a
};
mboxDefine=function(b,c){var a=mboxFactoryDefault.create(c,mboxShiftArray(mboxShiftArray(arguments)),b);
return a
};
...
var mboxFactoryDefault=new mboxFactory("ciscosystemsinc.tt.omtrdc.net","ciscosystemsinc","default")
...
document.write('<script language="Javascript1.2" src="http://admin16.testandtarget.omniture.com/admin/mbox/mbox_debug.jsp?mboxServerHost=ciscosystemsinc.tt.omtrdc.net&clientCode=ciscosystemsinc"><\/script>')
}mboxScPluginFetcher=function(a,c){this.b=a;
this.Ac=c
};
mboxScPluginFetcher.prototype.Bc=function(a){a.setBasePath("/m2/"+this.b+"/sc/standard");
this.Cc(a);
var b=a.buildUrl();
b+="&scPluginVersion=1";
return b
};
mboxScPluginFetcher.prototype.Cc=function(a){var c=["dynamicVariablePrefix","visitorID","vmk","ppu","charSet","visitorNamespace","cookieDomainPeriods","cookieLifetime","pageName","currencyCode","variableProvider","channel","server","pageType","transactionID","purchaseID","campaign","state","zip","events","products","linkName","linkType","resolution","colorDepth","javascriptVersion","javaEnabled","cookiesEnabled","browserWidth","browserHeight","connectionType","homepage","pe","pev1","pev2","pev3","visitorSampling","visitorSamplingGroup","dynamicAccountSelection","dynamicAccountList","dynamicAccountMatch","trackDownloadLinks","trackExternalLinks","trackInlineStats","linkLeaveQueryString","linkDownloadFileTypes","linkExternalFilters","linkInternalFilters","linkTrackVars","linkTrackEvents","linkNames","lnk","eo"];
for(var b=0;
b<c.length;
b++){this.Ec(c[b],a)
}for(var b=1;
...
mboxScPluginFetcher.prototype.Ec=function(c,a){var b=this.Ac[c];
if(typeof(b)==="undefined"||b===null||b===""){return
}a.addParameter(c,b)
};
mboxScPluginFetcher.prototype.cancel=function(){};
mboxStandardScPluginFetcher=function(a,c){mboxScPluginFetcher.call(this,a,c)
};
...
mboxStandardScPluginFetcher.prototype.fetch=function(a){a.setServerType(this.getType());
var b=this.Bc(a);
document.write('<script src="'+b+'" language="JavaScript"><\/script>')
};
mboxAjaxScPluginFetcher=function(a,c){mboxScPluginFetcher.call(this,a,c)
};
mboxAjaxScPluginFetcher.prototype=new mboxScPluginFetcher;
mboxAjaxScPluginFetcher.prototype.fetch=function(a){a.setServerType(this.getType());
var b=this.Bc(a);
this.x=document.createElement("script");
this.x.src=b;
document.body.appendChild(this.x)
...
if(d){var e=mboxFactoryDefault.isDomLoaded()?new mboxAjaxScPluginFetcher(this.b,this.s):new mboxStandardScPluginFetcher(this.b,this.s);
d.setFetcher(e);
d.load()
}};
b.isEnabled=function(){return this.H&&mboxFactoryDefault.isEnabled()
};
b.Hc=function(){var d=this.Ic();
var e=document.createElement("DIV");
return mboxFactoryDefault.create(d,new Array(),e)
};
b.Ic=function(){var d=this.s.events&&this.s.events.indexOf("purchase")!=-1;
return"SiteCatalyst: "+(d?"purchase":"event")
}
};
return a.loadModule("tt")
}function mboxGetGUTCCookie(){}};